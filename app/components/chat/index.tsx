            ...
            <Card className="p-2 max-h-[150px] overflow-y-auto">
              <div className="relative">
                ...
                <Textarea
                  ref={textareaRef}
                  className={cn(
                    'min-h-[40px] max-h-[100px] border-0 bg-transparent resize-none focus-visible:ring-0 focus-visible:ring-offset-0 pr-[118px] py-2 text-base',
                  ...
                  placeholder={t('common.operation.send') || '메시지를 입력하세요...'}
                  rows={1}
                />
